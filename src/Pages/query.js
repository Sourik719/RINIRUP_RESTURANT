...
function Query(){
    return(
        ...
        <div className="col-md-6">
            <h1 className="display-4 fw-normal text-dark">Ask Your Query</h1>
        ...
        <div className="mb-3">
        <label for="exampleFormControlInput1" className="form-label">Have a prior experience with RRR?</label>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-body">
              Are you ready to submit your query?
            </div>
      ...
      <div className="modal" id="exampleModal1" tabindex="-1">
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>Your query is successfully recieved.</p>
            </div>
            <div className="modal-footer">
                <NavLink className="btn btn-secondary" to="../Query" role="button">Have another query?</NavLink>
